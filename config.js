...
window.config = {
    microservicios: {
        funcionariosService: 'http://localhost:8082', // Base URL de funcionarios y gestión
        informesService: 'http://localhost:8082', // Base URL de control de certificados de RTM
